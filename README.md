...
# Nextflow
Before srunning the workflow, make sure to configure the nextflow and then docker, It can be challenging sometime especially if you are new to nextflow and docker. Once you have set up your system with both, it is very to run your workflows.
